...
from TohidXMusic.utils import help_pannel
from TohidXMusic.utils.database import get_lang
from TohidXMusic.utils.decorators.language import LanguageStart, languageCB
from TohidXMusic.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from TohidXMusic.utils.stuffs.buttons import BUTTONS
from TohidXMusic.utils.stuffs.helper import Helper
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_video(
            video="https://files.catbox.moe/86gacu.mp4",
